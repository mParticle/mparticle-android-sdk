 ...
 * <p/>
 */
public class EmbeddedComscore extends EmbeddedProvider implements ActivityLifecycleForwarder, ClientSideForwarder {
    ...
    public EmbeddedComscore(int id, EmbeddedKitManager ekManager) {
        super(id, ekManager);
