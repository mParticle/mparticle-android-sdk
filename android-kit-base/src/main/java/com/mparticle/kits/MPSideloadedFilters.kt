...
class MPSideloadedFilters private constructor(builder: Builder) {

    var filters: MutableMap<String, JSONObject> = builder.filters
        private set
    ...
    class Builder {
        ...
        internal var filters: MutableMap<String, JSONObject> = mutableMapOf()
        ...
        fun addEventTypeFilter(eventType: EventType): Builder {
            applyToFiltersNode(
         ...
         * @return Builder instance
         */
        fun addScreenNameFilter(screenName: String): Builder {
            applyToFiltersNode(
        ...
        fun addEventAttributeFilter(
            ...
            applyToFiltersNode(
                ...
                Pair(
                    HashingUtility.hashFilterEventAttributes(
                        eventType,
                        eventName,
                        customAttributeKey
                    )
        ...
        fun addUserIdentityFilter(userIdentityType: MParticle.IdentityType): Builder {
            applyToFiltersNode(
        ...
        fun addUserAttributeFilter(userAttributeKey: String): Builder {
            applyToFiltersNode(
        ...
        fun addCommerceEventEntityTypeFilter(commerceEventType: CommerceEventKind): Builder {
        ...
        fun addCommerceEventAppFamilyAttributeFilter(attributeKey: String): Builder {
            applyToFiltersNode(
...
// NOTE: This is iOS/Android only, web has a different signature
        ...
        fun build(): MPSideloadedFilters {
            return MPSideloadedFilters(this)
        }
    }
