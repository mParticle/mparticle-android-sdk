...
public class EmbeddedKochava extends EmbeddedProvider implements ActivityLifecycleForwarder {
    ...
    public EmbeddedKochava(int moduleId, EmbeddedKitManager context) {
