...
public class Screen1Activity extends Activity {
    ...
    Handler handler = new Handler() {
    	...
    	public void handleMessage(Message msg) {
			if (mParticleAPI != null) {
	    		if (mCurrent-- > 0) {
    				mParticleAPI.logEvent("StreamScreen1Message"+mCurrent, EventType.UserContent);
    				mText.setText( String.format(getString(R.string.screenmessage), 1, mCurrent, "streaming"));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mText.setText( String.format(getString(R.string.screenmessage), 1, EVENT_COUNT, "streaming"));
