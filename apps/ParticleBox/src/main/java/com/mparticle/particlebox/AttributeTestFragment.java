 ...
 */
public class AttributeTestFragment extends Fragment implements View.OnClickListener {
    ...
    public static AttributeTestFragment newInstance(int sectionNumber) {
        AttributeTestFragment fragment = new AttributeTestFragment();
