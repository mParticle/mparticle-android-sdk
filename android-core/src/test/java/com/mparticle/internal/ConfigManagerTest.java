...
public class ConfigManagerTest {
    ...
    public void setUp() throws Exception {
        ...
        manager = new ConfigManager(context, MParticle.Environment.Production, "some api key", "some api secret", null, null, null);
    ...
    public void testRestrictAAIDBasedOnLAT() throws Exception {
        ConfigManager testManager = new ConfigManager(context, MParticle.Environment.Production, "some api key", "some api secret", null, null, null);
