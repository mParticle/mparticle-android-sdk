...
public class ConfigManagerTest {
    ...
    public void setUp() throws Exception {
        ...
        ekManager = new MockKitManager(new com.mparticle.mock.MockContext());
    ...
    public void testSetEmbeddedKitManager() throws Exception {
        KitManager ekManager = new MockKitManager(new com.mparticle.mock.MockContext());
        manager.setKitManager(ekManager);
    }
