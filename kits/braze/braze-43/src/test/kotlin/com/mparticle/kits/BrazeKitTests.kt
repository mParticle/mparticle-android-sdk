...
//    }
    ...
    fun onConsentStateUpdatedTest() {
        ...
        var kitConfiguration =
            MockKitConfiguration.createKitConfiguration(JSONObject().put("as", JSONObject(map.toMutableMap() as Map<*, *>)))
        kit.configuration = kitConfiguration
    ...
    fun testOnConsentStateUpdatedTest_No_consentMappingSDK() {
        ...
        kit.configuration =
            KitConfiguration.createKitConfiguration(JSONObject().put("as", JSONObject(map.toMutableMap() as Map<*, *>)))
    ...
    private fun kitFilteringProductFields(
        ...
        val kitSettings = hashMapOf<String, String?>(BrazeKit.APPBOY_KEY to "key")
    ...
    fun testPurchaseDropsProductWithFilteredNameWhenNameIsTheIdentifier() {
        val kit =
            kitFilteringProductFields(
                ...
                settings = mapOf(BrazeKit.REPLACE_SKU_AS_PRODUCT_NAME to "True"),
            )
        val product = Product.Builder("product1", "1131331343", 13.0).build()
