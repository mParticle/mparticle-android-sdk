...
public class CommerceEventTest {
    ...
    public void testScreen() throws Exception {
        ...
        CommerceEvent event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).screen("some screen name").build();
    ...
    public void testAddProduct() throws Exception {
        ...
        CommerceEvent event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).addProduct(product2).build();
        ...
        stateException = null;
        try {
            event = new CommerceEvent.Builder(new CommerceEvent.Impression("name", product)).addProduct(product2).build();
        }catch (IllegalStateException ise) {
            stateException = ise;
        }
        assertNotNull("Should have thrown IllegalStateException", stateException);
    ...
    public void testTransactionAttributes() throws Exception {
        Product product = new Product.Builder("name", "sku", 0).build();
        CommerceEvent event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).transactionAttributes(new TransactionAttributes().setId("the id")).build();
        assertEquals("the id", event.getTransactionAttributes().getId());
        IllegalStateException stateException = null;
        try {
            event = new CommerceEvent.Builder(CommerceEvent.PURCHASE, product).build();
        }catch (IllegalStateException ise) {
            stateException = ise;
        }
        assertNotNull("Should have thrown IllegalStateException", stateException);
    ...
    public void testCurrency() throws Exception {
        Product product = new Product.Builder("name", "sku", 0).build();
        CommerceEvent event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).currency("test").build();
    ...
    public void testNonInteraction() throws Exception {
        Product product = new Product.Builder("name", "sku", 0).build();
        CommerceEvent event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).nonInteraction(true).build();
        assertTrue(event.getNonInteraction());
         event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).nonInteraction(false).build();
    ...
    public void testCustomAttributes() throws Exception {
        ...
        CommerceEvent event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).customAttributes(attributes).nonInteraction(true).build();
    ...
    public void testAddPromotion() throws Exception {
        ...
        IllegalStateException stateException = null;
        try {
            event = new CommerceEvent.Builder(CommerceEvent.ADD_TO_CART, product).nonInteraction(true).addPromotion(new Promotion().setId("promo id")).build();
        }catch (IllegalStateException ise) {
            stateException = ise;
        }
        assertNotNull("Should have thrown IllegalStateException", stateException);
    ...
    public void testAddImpression() throws Exception {
        Product product = new Product.Builder("name", "sku", 0).build();
        CommerceEvent event = new CommerceEvent.Builder(new CommerceEvent.Impression("name", product)).addImpression(new CommerceEvent.Impression("name 2", product)).nonInteraction(true).build();
