...
public class ConfigManagerTest {
    ...
    public void setUp() throws Exception {
        manager = new ConfigManager(new MockContext(), MParticle.Environment.AutoDetect);
        EmbeddedKitManager ekManager = new EmbeddedKitManager(new MockContext());
        manager.setEmbeddedKitManager(ekManager);
        manager.saveConfigJson(new JSONObject(sampleConfig));
        context.setSharedPreferences(manager.mPreferences);
    }
    ...
    public void testRestore() throws Exception {
        ...
        JSONObject object = new JSONObject(manager.mPreferences.getString(ConfigManager.CONFIG_JSON, null));
        assertNotNull(object);
        assertTrue(ConfigManager.getPushKeys(context).length() == 4);
    }
    ...
    public void testUpdateConfig() throws Exception {
        ...
        assertTrue(ConfigManager.getPushKeys(context).length() == 0);
