...
public class ProjectionTest {
    ...
    public void testDontAppendAsIs() throws Exception {
        ...
        info.put("another key", "another value");
        MPEvent event = new MPEvent.Builder("whatever", MParticle.EventType.Other).info(info).build();
        MPEvent newEvent = projection.project(new EmbeddedProvider.MPEventWrapper(event));
        ...
        newEvent = projection.project(new EmbeddedProvider.MPEventWrapper(event));
        assertTrue(newEvent.getInfo().size() == 2);
    }
    ...
    public void testFieldName() throws Exception {
        ...
        MPEvent projectedEvent = projection.project(new EmbeddedProvider.MPEventWrapper(event));
        assertEquals("screenname", projectedEvent.getInfo().get("screen_name_key"));
    }
    ...
    public void testRequiredDataType() throws Exception {
        ...
        MPEvent projectedEvent = projection.project(new EmbeddedProvider.MPEventWrapper(productEvent));
        ...
        projectedEvent = projection.project(new EmbeddedProvider.MPEventWrapper(productEvent));
        assertNull(projectedEvent);
        ...
        productEvent = new MPEvent.Builder(MPProduct.Event.VIEW.toString(), MParticle.EventType.Transaction).info(product).build();
        projectedEvent = projection.project(new EmbeddedProvider.MPEventWrapper(productEvent));
        assertNotNull(projectedEvent);
        assertEquals("cool add to cart, man!", projectedEvent.getEventName());
    ...
    public void testOptionalDataType() throws Exception {
        ...
        MPEvent projectedEvent = projection.project(new EmbeddedProvider.MPEventWrapper(productEvent));
        assertEquals("cool add to cart, man!", projectedEvent.getEventName());
        assertNull(projectedEvent.getInfo().get("key 1"));
        assertNull(projectedEvent.getInfo().get("key 2"));
        assertNull(projectedEvent.getInfo().get("key 3"));
        ...
        projectedEvent = projection.project(new EmbeddedProvider.MPEventWrapper(productEvent));
        assertEquals("cool add to cart, man!", projectedEvent.getEventName());
        assertEquals("2323232", projectedEvent.getInfo().get("key 1"));
        assertNull(projectedEvent.getInfo().get("key 2"));
        assertNull(projectedEvent.getInfo().get("key 3"));
        ...
        assertEquals("cool add to cart, man!", projectedEvent.getEventName());
        assertEquals("2323232", projectedEvent.getInfo().get("key 1"));
        assertEquals("232211", projectedEvent.getInfo().get("key 2"));
        assertNull(projectedEvent.getInfo().get("key 3"));
        ...
        assertEquals("2323232", projectedEvent.getInfo().get("key 1"));
        assertEquals("232211", projectedEvent.getInfo().get("key 2"));
        assertNotNull(projectedEvent.getInfo().get("key 3"));
        assertTrue(Boolean.parseBoolean(projectedEvent.getInfo().get("key 3")));
        ...
        assertEquals("232211", projectedEvent.getInfo().get("key 2"));
        assertNotNull(projectedEvent.getInfo().get("key 3"));
        assertFalse(Boolean.parseBoolean(projectedEvent.getInfo().get("key 3")));
    }
    ...
    public void testStringMatch() throws Exception {
        ...
        List<MPEvent> list = provider.projectEvents(productEvent);
        assertEquals(1, list.size());
        ...
        assertEquals(1, list.size());
        projectedProductEvent = list.get(0);
    ...
    public void testEventWrapper() {
        ...
        EmbeddedProvider.MPEventWrapper wrapper = new EmbeddedProvider.MPEventWrapper(event);
