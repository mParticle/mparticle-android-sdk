...
public class MPService extends IntentService {
    ...
    public final void onHandleIntent(Intent intent) {
        try {
            ...
            MParticle.getInstance().internal().getEmbeddedKitManager().handleIntent(intent);
    ...
    private void handleMessage(Intent intent) {
        ...
        try {
            ...
            if (!MParticle.getInstance().internal().getIsAppRunning()) {
            ...
            if (!newExtras.containsKey(Constants.MessageKey.APP_STATE)) {
                if (mMParticle.internal().getAppStateManager().isBackgrounded()) {
