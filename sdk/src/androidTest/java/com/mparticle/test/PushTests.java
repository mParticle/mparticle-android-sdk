...
public class PushTests extends AndroidTestCase {
    ...
    public void testProviderMessageCreation(){
        ...
        assertEquals("Title differed!",notification.extras.get(Notification.EXTRA_TITLE), notificationMessage);
    }
